...
outlierrice_url = "https://github.com/Manish-bit/Models/raw/master/outlierrice"
final2_url = "https://github.com/Manish-bit/Models/raw/master/final2"

outlierrice_path = "outlierrice.h5"
final2_path = "final2.h5"
...
download_model(outlierrice_url, outlierrice_path)
download_model(final2_url, final2_path)

# Load the models
MODEL = tf.keras.models.load_model(outlierrice_path)
CLASS_NAMES = ['No Rice', 'Rice']

DISEASE_MODEL = tf.keras.models.load_model(final2_path)
DISEASE_CLASS_NAMES = ['Brown Spot', 'Healthy', 'Leaf Blight', 'Tungro']

# Remove the downloaded model files
os.remove(outlierrice_path)
